      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align: right;">
            <a href="<?php echo e(url('admin/class/add')); ?>" class="btn btn-primary">Add new Class</a>
          </div>
              ...
              <form method="get" action="">
                ...
                <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <a href="<?php echo e(url('admin/class/list')); ?>" class="btn btn-success" type="submit" style="margin-top: 30px;">Reset</a>
                  </div>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <?php endif; ?>
                              ...
                              <td>
                                <a href="<?php echo e(url('admin/class/edit/' .$value->id)); ?>" class="btn btn-primary">Edit</a>
                                <a href="<?php echo e(url('admin/class/delete/' .$value->id)); ?>" class="btn btn-danger">Delete</a>
                              </td>
                          </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\student-management\resources\views/admin/class/list.blade.php ENDPATH**/ ?>